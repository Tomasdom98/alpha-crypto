...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen py-12 relative hero-gradient" data-testid="portfolio-page">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <div className="flex items-center gap-3 mb-3">
                <h1 className="text-4xl md:text-5xl font-bold text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }} data-testid="portfolio-heading">
                  {tx.title}
                </h1>
